...
export class Backend implements backendInterface {
    ...
    async addCourse(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteCourse(arg0: Id): Promise<void> {
        if (this.processError) {
            try {
    ...
    async enroll(arg0: Id): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAvailableCourses(): Promise<Array<Model>> {
        if (this.processError) {
            try {
    ...
    async getCoursesByInstructor(arg0: string): Promise<Array<Model>> {
        if (this.processError) {
            try {
    ...
    async getCoursesForUser(arg0: Principal): Promise<Array<Model>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoursesForUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isUserEnrolled(arg0: Id): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isUserEnrolled(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
